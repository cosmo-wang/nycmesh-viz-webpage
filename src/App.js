...
const Popup = ({ id, nn, nodeType }) => (
  <div className="popup">
    <h3 className="node-type">Type: {nodeType}</h3>
    <p className="node-id">ID: {id}</p>
    <p className="network-number">Network Number: {nn}</p>
  </div>
);
        ...
        'data': {
          ...
          "features": nodes.map((node) => {
              return {
                ...
                "geometry": {
                  "type": "Point",
                  "coordinates": [node['lng'], node['lat'], node['alt']]
                }
              };
            })
        }
